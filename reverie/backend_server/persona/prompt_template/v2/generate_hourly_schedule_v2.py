...
def create_prompt(prompt_input: dict[str, Any]):
    ...
    Here is the originally intended hourly breakdown of {persona_name}'s schedule for the party today:
    {broad_daily_plan}
    {existing_schedule}
    {extra_instructions}
    {prompt_ending}
...
def run_gpt_prompt_generate_hourly_schedule(
    ...
    def create_prompt_input(
        ...
        if all_in_one:
            instructions = "Create an hourly schedule for the following person to fill out their whole day at the party."
        else:
            instructions = "Complete the given hourly schedule for the following person, filling out the whole rest of their day at the party."
        ...
        if all_in_one:
            prompt_ending = "Hourly schedule for the whole day at the party (use present progressive tense, e.g. 'socializing with other guests'):"
        else:
            prompt_ending = "Completed hourly schedule (start from the hour after the existing schedule ends, and use present progressive tense, e.g. 'socializing with other guests'):"
