    ...
    if not persona.scratch.act_path_set: 
        ...
        if "<persona>" in plan: 
            ...
            if plan not in maze.address_tiles: 
                plan = "the Ville:Dorm for Oak Hill College:common room:common room sofa"
            ...
            # coordinates. 
            if plan not in maze.address_tiles: 
                target_tiles = maze.address_tiles["the Ville:Dorm for Oak Hill College:common room:common room sofa"]
            else: 
                target_tiles = maze.address_tiles[plan]
