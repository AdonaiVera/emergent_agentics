...
def main():
    ...
    categories = [
        ...
        "Electricity & Energy",
        "Water & Drowning Risk",
        "Confined Spaces & Air Quality",
        "Height & Falling",
        "Crowd & Stampede Dynamics",
        "Explosives & Pressure",
        "Sharp & Shattering Objects",
        "Temperature Extremes",
        "Structural Collapse & Breakage",
        "Chemical Reactions & Fumes",
        "Improvised Sports in Unsafe Areas",
        "Mechanical Hazards",
        "Unstable Surfaces",
        "Light & Visual Overload",
        "Sound & Vibration Overload",
        "Overloaded Food & Drink Challenges",
        "Distraction & Coordination Games",
        "Extreme Weather Exposure",
        "Transport in Motion",
        "Mixed Hazard Mashups"
    ]
